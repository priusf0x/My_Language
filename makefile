SOURCES = \
		  common/tools.cpp\
 		  ...
 		  front_end/recursive_decent.cpp\
		  common/vector/vector.cpp\
		  front_end/buffer.cpp\
		  front_end/tokenization.cpp\
...
CFLAGS += -I$(SOURCE_DIR) -I$(SOURCE_DIR)/common -I$(SOURCE_DIR)/common/tree -I$(SOURCE_DIR)/common/stack -I$(SOURCE_DIR)/front_end/state_machine_generator -I$(SOURCE_DIR)/front_end -I$(SOURCE_DIR)/common/vector
CFLAGS += -lm

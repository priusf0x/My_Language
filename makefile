...
CFLAGS += -I$(SOURCE_DIR) -I$(SOURCE_DIR)/recursive_decent -I$(SOURCE_DIR)/common -I$(SOURCE_DIR)/tree -I$(SOURCE_DIR)/stack -I$(SOURCE_DIR)/recursive_decent/state_machine_generator -I$(SOURCE_DIR)/front_end
CFLAGS += -lm
